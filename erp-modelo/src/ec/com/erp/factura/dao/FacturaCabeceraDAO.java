...
public class FacturaCabeceraDAO implements IFacturaCabeceraDAO {
	...
	public Collection<FacturaCabeceraDTO> obtenerListaFacturas(Integer codigoCompania, String numeroFactura, Timestamp fechaFacturaInicio, Timestamp fechaFacturaFin,  String docClienteProveedor, String nombClienteProveedor, Boolean pagado, Collection<String> tiposDocumentos, Long codigoVendedor) throws ERPException{
		try {
			...
			projectionList.add(Projections.property("personaDTO.nombreCompleto"), "vendedorDTO_personaDTO_nombreCompleto");
	...
	public Collection<FacturaCabeceraDTO> obtenerListaFacturasCanceladas(Integer codigoCompania, String numeroFactura, Timestamp fechaFacturaInicio, Timestamp fechaFacturaFin,  String docClienteProveedor, String nombClienteProveedor, Boolean pagado, Collection<String> tiposDocumentos, Long codigoVendedor) throws ERPException{
		try {
			...
			//restricciones
			criteria.add(Restrictions.eq("root.id.codigoCompania", codigoCompania));
			criteria.add(Restrictions.eq("root.estado", ERPConstantes.ESTADO_INACTIVO_NUMERICO));
	...
	public Collection<FacturaCabeceraDTO> obtenerListaFacturasElectronicas(Integer codigoCompania, String numeroFactura, Timestamp fechaFacturaInicio, Timestamp fechaFacturaFin,  String docClienteProveedor, String nombClienteProveedor) throws ERPException{
		try {
			...
			criteria.createAlias("vendedorDTO.personaDTO", "personaDTO", CriteriaSpecification.LEFT_JOIN);
			criteria.createAlias("root.facturaDetalleDTOCols", "facturaDetalleDTOCols", CriteriaSpecification.INNER_JOIN);
			criteria.createAlias("root.facturaDocumentoDTOCols", "facturaDocumentoDTOCols", CriteriaSpecification.INNER_JOIN);
			criteria.createAlias("root.pagosFacturaDTOCols", "pagosFacturaDTOCols", CriteriaSpecification.LEFT_JOIN);
			criteria.createAlias("root.tipoDocumentoCatalogoValorDTO", "tipoDocumentoCatalogoValorDTO", CriteriaSpecification.INNER_JOIN);
			criteria.createAlias("facturaDetalleDTOCols.articuloDTO", "articuloDTO", CriteriaSpecification.LEFT_JOIN);
			...
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.id.codigoArticulo"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_id_codigoArticulo");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.id.codigoArticuloUnidadManejo"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_id_codigoArticuloUnidadManejo");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.valorUnidadManejo"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_valorUnidadManejo");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.codigoValorUnidadManejo"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_codigoValorUnidadManejo");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.codigoTipoUnidadManejo"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_codigoTipoUnidadManejo");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.esPorDefecto"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_esPorDefecto");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.estado"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_estado");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.usuarioRegistro"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_usuarioRegistro");
			projectionList.add(Projections.property("articuloUnidadManejoDTOCols.fechaRegistro"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_fechaRegistro");
			
			projectionList.add(Projections.property("tipUniManCatValDTO.nombreCatalogoValor"), "facturaDetalleDTOCols_articuloDTO_articuloUnidadManejoDTOCols_tipoUnidadManejoCatalogoValorDTO_nombreCatalogoValor");
...
//			criteria.add(Restrictions.eq("root.estado", ERPConstantes.ESTADO_ACTIVO_NUMERICO));
	...
	public void guardarActualizarFacturaCabecera(FacturaCabeceraDTO facturaCabeceraDTO) throws ERPException{
		try{
			...
			if(facturaCabeceraDTO.getId().getCodigoFactura() ==  null){
				...
				if(facturaCabeceraDTO.getCodigoReferenciaFactura() == null && facturaCabeceraDTO.getCodigoValorTipoDocumento().equals(ERPConstantes.CODIGO_CATALOGO_VALOR_DOCUMENTO_VENTAS)) {
				...
				if(facturaCabeceraDTO.getActualizarSecuencia() != null && facturaCabeceraDTO.getActualizarSecuencia()){
					this.secuenciaDAO.obtenerSecuencialTabla(FacturaCabeceraID.NOMBRE_SECUENCIA_FACTURA_RUC_UNO);
				}
	...
	public void inactivarFacturaElectronica(Integer codigoCompania, Long codigoFactura, String userId)throws ERPException{
		try {
			...
			session.clear();
			StringBuilder sqlExecute = new StringBuilder();
			sqlExecute.append("UPDATE SCVNTFACTURACABECERA SET ESTADO = :pEstado, USUARIOMODIFICACION = :pUsuarioModificacion, FECHAMODIFICACION = :pFechaModificacion"
					+ " WHERE CODIGOCOMPANIA = :pCodigoCompania AND CODIGOFACTURA = :pCodigoFactura ");
			SQLQuery query = session.createSQLQuery(sqlExecute.toString());
			query.setParameter("pEstado", ERPConstantes.ESTADO_INACTIVO_NUMERICO);
			query.setParameter("pCodigoCompania", codigoCompania);
			query.setParameter("pCodigoFactura", codigoFactura);
			query.setParameter("pUsuarioModificacion", userId);
			query.setParameter("pFechaModificacion", Calendar.getInstance().getTime());
	...
	public Collection<ReporteVentasFacturasVO> obtenerReporteVentasFactura(Integer codigoCompania, Boolean pagada, Long codigoVendedor, Timestamp fechaFacturaInicio, Timestamp fechaFacturaFin) throws ERPException{
		try {
			...
			//joins
			Criteria criteria  = session.createCriteria(FacturaCabeceraDTO.class, "root");
			criteria.createAlias("root.vendedorDTO", "vendedorDTO", CriteriaSpecification.INNER_JOIN);
			...
			//proyecciones entidad negociacion proveedor
			ProjectionList projectionList = Projections.projectionList();
			projectionList.add(Projections.property("personaDTO.nombreCompleto"), "nombreVendedor");
			projectionList.add(Projections.property("root.numeroDocumento"), "numeroDocumento");
			projectionList.add(Projections.property("root.rucDocumento"), "rucDocumentoCliente");
			projectionList.add(Projections.property("root.nombreClienteProveedor"), "razonSocialCliente");
			projectionList.add(Projections.property("root.tipoCliente"), "tipoCliente");
			projectionList.add(Projections.property("root.pagado"), "pagada");
			projectionList.add(Projections.property("root.fechaDocumento"), "fechaVenta");
			projectionList.add(Projections.property("root.subTotal").as("subTotal"));
			projectionList.add(Projections.property("root.totalSinImpuestos").as("tarifaCero"));
			projectionList.add(Projections.property("root.totalImpuestos").as("tarifaImpuesto"));
			projectionList.add(Projections.property("root.totalIva").as("totalIva"));
			projectionList.add(Projections.property("root.totalCuenta").as("totalVenta"));
			projectionList.add(Projections.property("root.descuento").as("totalDescuento"));
			criteria.setProjection(projectionList);
			criteria.addOrder(Order.asc("root.nombreClienteProveedor"));
			criteria.setResultTransformer(new MultiLevelResultTransformer(ReporteVentasFacturasVO.class));
			Collection<ReporteVentasFacturasVO> facturaCabeceraDTOCols = new ArrayList<>();
			facturaCabeceraDTOCols = criteria.list();
			return facturaCabeceraDTOCols;
			...
			throw (ERPException)new ERPException("Error al obtener reporte de ventas por facturas.").initCause(e);
		} 
	}
}
