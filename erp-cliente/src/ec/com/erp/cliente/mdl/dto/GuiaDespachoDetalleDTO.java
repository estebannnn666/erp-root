 ...
 */
@Entity
@Table(name="SCVNTGUIADESPACHODETALLE")
public class GuiaDespachoDetalleDTO implements Serializable{
	private static final long serialVersionUID = 7863262235394607247L;

	@EmbeddedId
	private GuiaDespachoDetalleID id = new GuiaDespachoDetalleID();
	...
	public GuiaDespachoDetalleID getId() {
		return id;
	}

	public void setId(GuiaDespachoDetalleID id) {
		this.id = id;
	}
